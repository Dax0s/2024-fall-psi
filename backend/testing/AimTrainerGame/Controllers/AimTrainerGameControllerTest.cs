...
public class AimTrainerGameControllerTest
{
    ...
    public async Task StartGame_ValidRequest_ReturnsOkResult()
    {
        ...
        var result = await _controller.StartGame(request).ConfigureAwait(false);
    ...
    public async Task GetHighscores_ValidRequest_ReturnsOkResult(int amount)
    {
        ...
        var result = await _controller.GetHighscores(amount).ConfigureAwait(false);
    ...
    public async Task EndGame_ValidRequest_ReturnsOkResult(string username, int score)
    {
        ...
        var result = await _controller.EndGame(new GameEndRequest(username, score)).ConfigureAwait(false);
    ...
    {
        var result = await _controller.EndGame(new GameEndRequest("", 10)).ConfigureAwait(false);
